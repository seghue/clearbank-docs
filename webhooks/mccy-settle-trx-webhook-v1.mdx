...
<Callout colour="blue"><h2>Deprecation notice</h2><p>The <strong>Multi-currency Transaction Settled webhook version 1</strong> was deprecated on <strong>25 September 2024</strong> and is no longer recommended for new development. The webhook will remain available for use until <strong>25 March 2025</strong>. <br/> You should instead use version 2 of the webhook. Please reach out to your Client Director with any questions. <br/> For more details, please refer to our <a href="https://clearbank.github.io/uk/docs/api/versioning">versioning policy</a> and <a href="https://clearbank.github.io/uk/docs/api/support-life-cycle">support lifecycle information</a>.</p>
</Callout>
